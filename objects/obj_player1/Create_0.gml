...
switch(sprite_index)
{
	...
	case spr_kepler: thrustYOffset = 9; thrustXOffset = 29; thrust = global.shipStats[4,2]/100; fireRate = 30 - (global.shipStats[4,3]*2); spray = 10 - global.shipStats[4,5]; missileAmmo = 0 missile = false; bulletSpeed = 6; bulletLife = 100; turnSpeed = global.shipStats[4,6]*0.4; break;
}
