...
switch(sprite_index)
{
	...
	case spr_longbow: thrustYOffset = 5; thrustXOffset = 24; thrust = global.shipStats[2,2]/100; fireRate = 30 - (global.shipStats[2,3]*2); spray = 10 - global.shipStats[2,5]; missileAmmo = 0; missile = false; bulletSpeed = 12; bulletLife = 150; turnSpeed = global.shipStats[2,6]*0.4; break;
	...
	case spr_kepler: thrustYOffset = 13; thrustXOffset = 28; thrust = global.shipStats[4,2]/100; fireRate = 30 - (global.shipStats[4,3]*2); spray = 10 - global.shipStats[4,5]; missileAmmo = 0 missile = false; bulletSpeed = 6; bulletLife = 100; turnSpeed = global.shipStats[4,6]*0.4; break;
}
