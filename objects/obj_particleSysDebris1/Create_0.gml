...
// direction and speed
var relHspeed = obj_cpuShip.hspeed - obj_player1.hspeed;
var relVspeed = obj_cpuShip.vspeed - obj_player1.vspeed;

var P1Direction = point_direction(0,0,relHspeed,relVspeed);
var P1Speed = point_distance(0,0,relHspeed,relVspeed);
