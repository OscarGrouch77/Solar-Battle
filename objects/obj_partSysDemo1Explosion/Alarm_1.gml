...
scr_genericExplosion2(expx + lengthdir_x(astSpeed*40, astDirection),expy + lengthdir_y(astSpeed*40, astDirection), obj_partSysDemo1Explosion.player2ExplosionBot, obj_partSysDemo1Explosion.player2ExplosionTop, obj_partSysDemo1Explosion.particle1, obj_partSysDemo1Explosion.particle2);