...
#region quadratic method
	...
	var relX = obj_player1.x - x;
	var relY = obj_player1.y - y;
	var relHspeed = obj_player1.hspeed - hspeed;
	var relVspeed = obj_player1.vspeed - vspeed;
...
#region iterative method
	...
	//relative velocity of player ship to cpu ship
		...
		//defining variables
		var enemyDis = point_distance(x, y, obj_player1.x, obj_player1.y);
		var timeToHit = enemyDis/point_distance(0,0,bullHrel,bullVrel);
		
		//predicting x and y of enemy when bullet arrives
		var aimX = obj_player1.x + lengthdir_x(obj_player1.speed * timeToHit, obj_player1.direction);
		var aimY = obj_player1.y + lengthdir_y(obj_player1.speed * timeToHit, obj_player1.direction);
		...
		var aimX2 = obj_player1.x + lengthdir_x(obj_player1.speed * timeToHit2, obj_player1.direction);
		var aimY2 = obj_player1.y + lengthdir_y(obj_player1.speed * timeToHit2, obj_player1.direction);
		...
		//predicting x and y of enemy with new variables
		var aimX3 = obj_player1.x + lengthdir_x(obj_player1.speed * timeToHit3, obj_player1.direction);
		var aimY3 = obj_player1.y + lengthdir_y(obj_player1.speed * timeToHit3, obj_player1.direction);
		...
		//predicting x and y of enemy with new variables
		aimX4 = obj_player1.x + lengthdir_x(obj_player1.speed * timeToHit4, obj_player1.direction);
		aimY4 = obj_player1.y + lengthdir_y(obj_player1.speed * timeToHit4, obj_player1.direction);
		...
		//predicting x and y of enemy with new variables
		aimX5 = obj_player1.x + lengthdir_x(obj_player1.speed * timeToHit5, obj_player1.direction);
		aimY5 = obj_player1.y + lengthdir_y(obj_player1.speed * timeToHit5, obj_player1.direction);
