...
scr_genericExplosion2(expx + lengthdir_x(astSpeed*40, astDirection),expy + lengthdir_y(astSpeed*40, astDirection), obj_partSysDemo2Explosion.player2ExplosionBot, obj_partSysDemo2Explosion.player2ExplosionTop, obj_partSysDemo2Explosion.particle1, obj_partSysDemo2Explosion.particle2);