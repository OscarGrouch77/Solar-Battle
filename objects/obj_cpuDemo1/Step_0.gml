...
{
	enemyDir = point_direction(x, y, obj_cpuDemo2.x, obj_cpuDemo2.y);
	enemyDis = point_distance(x, y, obj_cpuDemo2.x, obj_cpuDemo2.y);
}
...
if (firing == true) and (cooldown <= 0)
{
	if (double == false)
	{
		instance_create_layer(x,y,"Bullets",obj_bulletDemo1);			//creates bullet if cooldown 0
	}
	if (double == true)
	{
		instance_create_layer(x + lengthdir_x(11, (image_angle + 90)), y + lengthdir_y(11, (image_angle + 90)),"Bullets",obj_bulletDemo1);
		instance_create_layer(x + lengthdir_x(11, (image_angle - 90)), y + lengthdir_y(11, (image_angle - 90)),"Bullets",obj_bulletDemo1);
	}
	cooldown = 15;
	overheat = overheat + 2;
