...
player1ExplosionTop2 = part_system_create_layer("topParticle", false);
...
scr_p1Explosion2(expx + lengthdir_x(astSpeed*40, astDirection),expy + lengthdir_y(astSpeed*40, astDirection));