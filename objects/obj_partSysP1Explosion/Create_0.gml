...
player1ExplosionBot = part_system_create_layer("bottomParticle", false);
player1ExplosionTop = part_system_create_layer("topParticle", false);


//get direction, speed, and location of player at moment of destruction
astDirection = obj_player1.direction;
astSpeed = obj_player1.speed;
expx = obj_player1.x;
expy = obj_player1.y;
