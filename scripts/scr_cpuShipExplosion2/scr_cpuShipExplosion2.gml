...
part_particles_create(obj_partSysCpuShipExplosion.player2ExplosionTop2, xx + random_range(-16,16), yy + random_range(-16,16), obj_partSysCpuShipExplosion.particle4, 2);
part_particles_create(obj_partSysCpuShipExplosion.player2ExplosionTop2, xx + random_range(-16,16), yy + random_range(-16,16), obj_partSysCpuShipExplosion.particle4, 2);
part_particles_create(obj_partSysCpuShipExplosion.player2ExplosionTop2, xx + random_range(-16,16), yy + random_range(-16,16), obj_partSysCpuShipExplosion.particle4, 2);
